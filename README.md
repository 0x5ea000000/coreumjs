...
const balance = await client.cosmos.bank.v1beta1
    .allBalances({ address: 'coreum1addresshere' });

// you can also query the coreum modules
const balances = await client.coreum.exchange.v1beta1
    .exchangeBalances()
```
...
const {
    ...
    deposit
} = coreum.exchange.v1beta1.MessageComposer.withTypeUrl;
```
