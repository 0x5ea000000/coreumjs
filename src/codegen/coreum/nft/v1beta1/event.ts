...
export interface EventSendProtoMsg {
  typeUrl: "/coreum.nft.v1beta1.EventSend";
  value: Uint8Array;
}
/** EventSend is emitted on Msg/Send */
...
export interface EventSendAminoMsg {
  type: "/coreum.nft.v1beta1.EventSend";
...
export interface EventMintProtoMsg {
  typeUrl: "/coreum.nft.v1beta1.EventMint";
  value: Uint8Array;
}
/** EventMint is emitted on Mint */
...
export interface EventMintAminoMsg {
  type: "/coreum.nft.v1beta1.EventMint";
...
export interface EventBurnProtoMsg {
  typeUrl: "/coreum.nft.v1beta1.EventBurn";
  value: Uint8Array;
}
/** EventBurn is emitted on Burn */
...
export interface EventBurnAminoMsg {
  type: "/coreum.nft.v1beta1.EventBurn";
