...
export class QueryClientImpl implements Query {
  ...
  classes(request: QueryClassesRequest = {
    ...
    const promise = this.rpc.request("coreum.nft.v1beta1.Query", "Classes", data);
